...
from ubinascii import hexlify as b2a_hex  # auto-gen
...
for i in range(3):
  ...
  assert b2a_hex(a.my_fp()).decode() == '3e5730c5'
  ...
  assert b2a_hex(a.my_fp()).decode() == 'b8a4bcff'
  ...
  assert b2a_hex(a.my_fp()).decode() == '0e20ad95'
  ...
  assert b2a_hex(a.my_fp()).decode() == 'f40e24a3'
  ...
  assert b2a_hex(a.my_fp()).decode() == '6535a0f5'
  ...
  assert b2a_hex(a.my_fp()).decode() == 'f0a9f581'
  ...
  assert b2a_hex(a.my_fp()).decode() == 'e1c4ee68'
  ...
  assert b2a_hex(a.my_fp()).decode() == '5dc3d644'
  ...
  assert b2a_hex(a.my_fp()).decode() == 'a1137a3b'
  ...
  assert b2a_hex(a.my_fp()).decode() == 'cb698e19'
